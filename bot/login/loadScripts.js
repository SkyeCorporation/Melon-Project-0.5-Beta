        ...
        for (const folderModules of folders) {
                ...
                for (const file of Files) {
                        ...
                        try {
                                ...
                                // Skip command if it's locked to a specific bot instance
                                if (configCommand.botInstance && process.env.BOT_INSTANCE &&
                                        configCommand.botInstance !== process.env.BOT_INSTANCE) {
                                        continue;
                                }
